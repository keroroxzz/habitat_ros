...
default_scene = "/home/rtu/dataset/habitat/00861-GLAQ4DNUx5U/GLAQ4DNUx5U.glb"
...
class HabitatSimInteractiveViewer(Application):
    def __init__(self) -> None:
        ...
        self.camera_pub = rospy.Publisher("camera_info",CameraInfo, latch=True, queue_size=10)

        # Init settings
        self.camera_info = self.loadCameraYaml("config/camera.yaml")
        self.sim_settings = self.make_sim_settings(self.camera_info)
        self.lidar = LiDAR("range_sensor", [0.0, self.sim_settings["sensor_height"], 0.0],"config/VLP_16_test.yaml")
